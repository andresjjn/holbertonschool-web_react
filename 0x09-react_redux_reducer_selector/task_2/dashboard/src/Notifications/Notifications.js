      ...
      <div className="NotificationsCointainer">
        {
          this.props.listNotifications.length > 0
            ? <React.Fragment>
              <div className="NotificationsTitle" onClick={handleDisplayDrawer}>Your notifications</div>
              {this.props.displayDrawer &&
                <div className="Notifications">
                  <button aria-label="Close" style={closeBtnStyles} onClick={handleHideDrawer}>X</button>
